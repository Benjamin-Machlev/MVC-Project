...
class MovieView(QMainWindow):
    movies = [
        ...
        Movie(10, "The Matrix", "Lana Wachowski, Lilly Wachowski", 1999, "Action, Sci-Fi", 8.7, 136, 
            ...
            ["Positive", "Nice Movie"], r"movies img/10.jpeg"),
